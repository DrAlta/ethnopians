...
pub fn main() {
    ...
    let character = Character {
        ...
        rules: vec![
            general_disapprove_fighting,
            specific_approve_righteous_fighting,
        ],
    };
    ...
    .into();
    let response_tags = ["fighting".to_string(), "righteous".to_string()].into();
    ...
    match determine_preference(&character, &event, &response) {
        Some(preference) => println!(
            "The Paladin's preference in this specific context: {:?}",
            preference
        ),
    ...
    let general_event_tags = ["artistic".to_string(), "show".to_string()].into();
    let general_response_tags = ["fighting".to_string(), "disruptive".to_string()].into();

    let general_event = Event {
        tags: general_event_tags,
    };
    let general_response = Response {
        tags: general_response_tags,
    };
