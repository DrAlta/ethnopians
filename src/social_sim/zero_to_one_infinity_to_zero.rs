...
pub fn calc_zero2one_infinity_to_zero_coefficient(target_input: Number, target_output: Number) -> Number {
...
pub fn zero2one_infinity_to_zero_with_coefficient(i: Number, coefficient: Number) -> Number {
    1/((i * coefficient) + Number::ONE)
}
pub fn zero2one_infinity_to_zero_throught_point(i: Number, target_input: Number, target_output: Number) -> Number {
