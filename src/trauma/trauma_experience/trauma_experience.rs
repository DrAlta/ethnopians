use crate::{trauma::{trauma_experience::InnerEvent, TraumaExperienceType}, Number};
...
impl TraumaExperience {
    ...
    pub fn add_event(
        ...
        self.ability_to_handle_gradient = (self.ability_to_handle_gradient + new_gradient_delta) * Number::HALF;
        self.ability_to_handle_y_intercept = (self.ability_to_handle_y_intercept + new_y_intercept_delta) * Number::HALF;
        self.inner_events.push(InnerEvent { trauma, base_traumatic_stressfulness });
    }
    pub fn simple_new(
        new_gradient_delta: Number, 
        new_y_intercept_delta: Number,
        ...
        Self{ 
            ...
            inner_events: vec![InnerEvent{trauma, base_traumatic_stressfulness}], 
        }
    }
}
