...
pub fn kelly_criterion(
    ...
    fraction_gain_on_win: Number,
    fraction_lost_on_lose: Number,
) -> Number {
    let probability_of_loosing = Number::ONE - probability_of_winning;
    let fraction_to_bet = (probability_of_winning / fraction_lost_on_lose)
        - (probability_of_loosing / fraction_gain_on_win);
    fraction_to_bet
}
    ...
    fn main() {
        ...
        assert_eq!(
            ...
            kelly_criterion(
                ...
                fraction_gain_on_win,
                fraction_lost_on_lose
            )
        );
    }
}
